...
```bash
 上架服务 ---> 上架服务方案料号 ---> 上架服务对应的方案 ---> 上架服务方案付费模式 ---> 上架按量计费料号（可选） ---> 上架服务方案部署配置（可选）
```
...
```bash
上架包服务 ---> 上架服务包方案料号 ---> 上架服务包对应的方案 ---> 上架服务包方案付费模式 ---> 上架按量计费料号（可选） ---> 上架服务包方案部署配置（可选）
```
...
5. 上架按量计费料号和定价，调用[上架按量计费料号接口](#上架按量计费料号接口)进行上架（可选）
6. 上架服务包方案部署配置，调用[上架服务方案部署配置接口](#上架服务方案部署配置接口)进行上架（可选）
...
:point_right: [上架按量计费料号接口](#上架按量计费料号接口)  

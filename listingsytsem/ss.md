...
```bash
上架包服务 ---> 上架服务包方案料号 ---> 上架服务包对应的方案 ---> 上架服务包方案付费模式 ---> 上架按量付费料号（可选） ---> 上架服务包方案部署配置（可选）
```

### 上架服务包步骤

1. 上架服务包，调用 [上架服务包接口](#上架服务包接口) 进行上架
2. 上架服务方案料号，调用 [上架服务包料号接口](#上架服务料号接口) 进行上架 
3. 上架服务包方案，调用[上架服务包方案接口](上架服务方案接口)进行上架
4. 上架服务包方案付费方式，调用[上架服务包方案付费方式接口](#上架服务方案付费方式接口)进行上架
5. 上架按量计费料号和定价，调用[上架按量付费料号接口](#上架按量付费料号接口)进行上架（可选）
6. 上架服务包方案部署配置，调用[上架服务包方案部署配置接口](#上架服务方案部署配置接口)进行上架（可选）

EnSaaS-K8s-Service 基于 Kubernetes 为用户提供了开箱即用的微服务框架、企业级的容器管理平台、多层级的租户工作空间以及一致性的基础设施封装，为应用提供了全生命周期管理。本手册将从应用管理、资源管理、用户管理、权限管理这几个方面来引导大家熟悉和使用EnSaaS-K8s-Service。
